...
public class SettlementRepositoryAdaptor implements SettlementRepository {
    ...
    @Override
    public Optional<Settlement> findByStoreIdAndSettlementMonth(Long storeId, YearMonth settlementMonth) {
    ...
    @Override
    public boolean existsByStoreIdAndSettlementMonthAndSettlementStatus(Long storeId, YearMonth settlementMonth, SettlementStatus settlementStatus) {
        return jpaSettlementRepository.existsByStoreIdAndSettlementMonthAndSettlementStatus(storeId, settlementMonth, settlementStatus);
    }
}

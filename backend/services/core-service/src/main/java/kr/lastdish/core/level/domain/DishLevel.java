...
public enum DishLevel {
  LEVEL_1(1, 0, new BigDecimal("0.05"), "양념 종지"), // Lv.1 양념 종지 (0회 이상 - 5회 미만 / 5%)
  LEVEL_2(2, 5, new BigDecimal("0.06"), "밥그릇"), // Lv.2 밥그릇 (5회 이상 - 10회 미만 / 6%)
  LEVEL_3(3, 10, new BigDecimal("0.07"), "뚝배기"), // Lv.3 뚝배기 (10회 이상 - 15회 미만 / 7%)
  LEVEL_4(4, 15, new BigDecimal("0.08"), "전골냄비"), // Lv.4 전골냄비 (15회 이상 - 20회 미만 / 8%)
  LEVEL_5(5, 20, new BigDecimal("0.10"), "가마솥"); // Lv.5 가마솥 (20회 이상 / 10%)

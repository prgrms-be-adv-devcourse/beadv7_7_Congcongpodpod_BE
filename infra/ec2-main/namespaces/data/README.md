...
```bash
kubectl apply -f infra/ec2-main/namespaces/data/redis/config.yaml
kubectl apply -f infra/ec2-main/namespaces/data/redis/workload.yaml
...
```bash
kubectl apply -f infra/ec2-main/namespaces/data/kafka/workload.yaml

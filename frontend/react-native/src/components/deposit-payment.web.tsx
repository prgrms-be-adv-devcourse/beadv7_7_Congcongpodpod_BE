...
export default function DepositPaymentScreen() {
  ...
  useEffect(() => {
    ...
    void approveDepositPayment(params.paymentKey, params.orderId, amount)
      .then(approved => router.replace({ pathname: '/deposits/charge/success', params: { amount: String(approved.amount), balance: String(approved.depositBalance) } }))

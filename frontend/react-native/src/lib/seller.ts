...
export type StorePayoutAccount = { payoutAccountId: number; storeId: number; bankName: string; accountNumber: string; accountHolder: string; active: boolean; updatedAt: string };

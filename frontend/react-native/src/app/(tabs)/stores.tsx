...
import { formatCheapestDishOffer, hasAvailableDish } from '@/lib/store-pricing';
...
export default function StoresScreen() {
  ...
  const filteredStores = useMemo(() => {
    ...
    return stores.filter((store) => {
      ...
      const availabilityMatch = !onlyAvailable || hasAvailableDish(store);
      ...
      return availabilityMatch && categoryMatch && keywordMatch;
    });
